...
# RefLex metadata was enriched by adding ISO codes, Glottolog 3.0 codes, English
# language names (where different from the French), and full citations to the
# original sources.
...
# Using write_csv() here because write_table doesn't handle UTF-8 well
save(d, file="reflex-data.Rdata")
write_csv(d,"reflex-data.csv")